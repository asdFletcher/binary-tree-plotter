...
import * as BST_insert_1000x1000_raw from '../data/BST_insert_1000x1000_raw.json';
import * as BST_insert_1000x1000_avg from '../data/BST_insert_1000x1000_avg.json';
...
import * as BST_insert_500000x100_raw from '../data/BST_insert_500000x100_raw.json';

import * as BST_delete_1000x1000_raw from '../data/BST_delete_1000x1000_raw.json';
import * as BST_delete_1000x1000_avg from '../data/BST_delete_1000x1000_avg.json';
import * as BST_delete_bad_1000x1000_raw from '../data/BST_delete_bad_1000x1000_raw.json';
import * as BST_delete_bad_1000x1000_avg from '../data/BST_delete_bad_1000x1000_avg.json';
...
import * as AVL_insert_1000x1000_raw from '../data/AVL_insert_1000x1000_raw.json';
import * as AVL_insert_1000x1000_avg from '../data/AVL_insert_1000x1000_avg.json';
